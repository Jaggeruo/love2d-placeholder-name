...
function Background:draw()
    ...
    love.graphics.print("Score: " .. self.score, self.gameX + 5, self.infoY + 5)
    love.graphics.print("Time: " .. self.time, self.gameX + 5, self.infoY + 70)
    love.graphics.print("Combo: x" .. self.combo, love.graphics.getWidth() / 2 - 15, self.infoY + 5)
    love.graphics.print(
